...
async function run() {
  ...
  await prisma.$executeRawUnsafe(`INSERT INTO leads (id, business_id, first_name, last_name, primary_phone, source, status, created_by_user_id, creation_channel, updated_at) VALUES ('d49b7490-03c4-4a10-a6e1-e3f383dbdba1', 'L-001', 'Test', 'Concur', '555123', 'WEBSITE', 'NEW', '${admin.id}', 'SALES_COUNSELLOR', NOW()) ON CONFLICT DO NOTHING`);
